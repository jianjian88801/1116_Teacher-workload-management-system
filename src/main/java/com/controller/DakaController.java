    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(daka !=null){
            ...
            BeanUtils.copyProperties( daka , view );//把实体数据重构到view中
                ...
                //级联表
                JiaoshiEntity jiaoshi = jiaoshiService.selectById(daka.getJiaoshiId());
                if(jiaoshi != null){
    ...
    */
    ...
    public R save(@RequestBody DakaEntity daka, HttpServletRequest request){
        ...
        if(false)
            ...
            daka.setJiaoshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<DakaEntity> queryWrapper = new EntityWrapper<DakaEntity>()
            .eq("jiaoshi_id", daka.getJiaoshiId())
...
//                            dakaEntity.setJiaoshiId(Integer.valueOf(data.get(0)));   //教师 要改的
