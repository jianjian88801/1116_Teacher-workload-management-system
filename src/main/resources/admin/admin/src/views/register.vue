<template>
    <div style="backgroundImage: url('/jiaoshigongzuoliang/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">教师工作量管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="教师身份证号" class="input" v-if="tableName=='jiaoshi'">
                            <el-input v-model="ruleForm.jiaoshiIdNumber" autocomplete="off" placeholder="教师身份证号"  />
                        </el-form-item>
