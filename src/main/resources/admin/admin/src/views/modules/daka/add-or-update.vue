    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="打卡备注" prop="dakaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.dakaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.dakaContent" label="打卡备注" prop="dakaContent">
                            <span v-html="ruleForm.dakaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
