    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工作量标题" prop="gongzuoliangName">
                       <el-input v-model="ruleForm.gongzuoliangName"
                                 placeholder="工作量标题" clearable  :readonly="ro.gongzuoliangName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="工作量标题" prop="gongzuoliangName">
                           <el-input v-model="ruleForm.gongzuoliangName"
                                     placeholder="工作量标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="工作量类型" prop="gongzuoliangTypes">
                        <el-select v-model="ruleForm.gongzuoliangTypes" :disabled="ro.gongzuoliangTypes" placeholder="请选择工作量类型">
                            <el-option
                                v-for="(item,index) in gongzuoliangTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="工作量类型" prop="gongzuoliangValue">
                        <el-input v-model="ruleForm.gongzuoliangValue"
                            placeholder="工作量类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="工作量详情" prop="gongzuoliangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.gongzuoliangContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gongzuoliangContent" label="工作量详情" prop="gongzuoliangContent">
                            <span v-html="ruleForm.gongzuoliangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工作量数值" prop="gongzuoliangNumber">
                       <el-input v-model="ruleForm.gongzuoliangNumber"
                                 placeholder="工作量数值" clearable  :readonly="ro.gongzuoliangNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="工作量数值" prop="gongzuoliangNumber">
                           <el-input v-model="ruleForm.gongzuoliangNumber"
                                     placeholder="工作量数值" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    jiaoshiId: false,
                    gongzuoliangName: false,
                    gongzuoliangTypes: false,
                    gongzuoliangContent: false,
                    gongzuoliangNumber: false,
                    gongzuoliangYesnoTypes: false,
                    gongzuoliangYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    jiaoshiId: '',
                    ...
                    gongzuoliangContent: '',
                    gongzuoliangNumber: '',
                    gongzuoliangYesnoTypes: '',
                    gongzuoliangYesnoText: '',
                    insertTime: '',
                },
                gongzuoliangTypesOptions : [],
                gongzuoliangYesnoTypesOptions : [],
                jiaoshiOptions : [],
                rules: {
                   jiaoshiId: [
                   ...
                   gongzuoliangName: [
                              { required: true, message: '工作量标题不能为空', trigger: 'blur' },
                          ],
                   gongzuoliangTypes: [
                   ...
                   gongzuoliangContent: [
                              { required: true, message: '工作量详情不能为空', trigger: 'blur' },
                          ],
                   gongzuoliangNumber: [
                              { required: true, message: '工作量数值不能为空', trigger: 'blur' },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=gongzuoliang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.gongzuoliangTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=gongzuoliang_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.gongzuoliangYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`gongzuoliang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.gongzuoliangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
